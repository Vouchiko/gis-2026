#!/usr/bin/env python3
"""
ЛР3: Генерация overture.geojson из данных Overture Maps + ЛР1.
Запуск: python lab_3/run_analysis.py
"""
import json
import os
import sys
...
GEOJSON_IN    = os.path.join(BASE_DIR, '..', 'lab_1', 'map.geojson')
...
# bbox по данным ЛР1 (с буфером ~1 км)
MINX, MINY, MAXX, MAXY = 50.30, 53.54, 50.39, 53.59
